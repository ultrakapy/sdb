...
A native x64 debugger built from the ground up in Modern C++, following the architectural patterns outlined in Sy Brand's *"Building a Debugger"* series and book. This project explores the low-level mechanics of the Linux `ptrace` system call, DWARF debug information, and breakpoint injection.
